...
namespace General.Controllers
{
    public class PersonelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,PId,FullName,Email,BirthDate,Mobile")] Personel personel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,PId,FullName,Email,BirthDate,Mobile")] Personel personel)
        {
            if (ModelState.IsValid)
            {
